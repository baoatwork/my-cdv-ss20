...
function gotData(incomingData){
  ...
  function drawViz(){
    ...
    let enteringElements = datagroups.enter().append("g").attr("class","datagroup");
    ...
    enteringElements.attr("transform",getIncomingLocation).transition().attr("transform",getGroupLocation);
